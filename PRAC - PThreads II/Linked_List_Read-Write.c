...
void Get_input(int* inserts_in_main_p) {
   ...
   printf("Numeros de Llaves insertados en el hilo principal: \n");
   scanf("%d", inserts_in_main_p);
   printf("Numero de ops?\n");
   scanf("%d", &total_ops);
   printf("Porcentanje - Member (Entre 0 y 1)\n");
   scanf("%lf", &search_percent);
   printf("Porcentanje - Insert? (Entre 0 y 1)\n");
